...
//
//public class ImageEditorActivity_BAK20160418 extends Activity {
...
//            super.onPreExecute();
//            mTaskDialog = new ProgressDialog(ImageEditorActivity_BAK20160418.this);
...
//                new ProgressDialog.Builder(ImageEditorActivity_BAK20160418.this)
//                .setTitle(R.string.no_font_file_title)
//                .setMessage(ImageEditorActivity_BAK20160418.this.getResources().getString(R.string.no_font_file_content))
//                .setPositiveButton("下载", new DialogInterface.OnClickListener() {
//                    @Override
//                    public void onClick(DialogInterface dialog, int which) {
//                        if (!CommonUtils.isNetAvailable(ImageEditorActivity_BAK20160418.this)) {
//                            ToastUtil.makeText(ImageEditorActivity_BAK20160418.this, getResources().getString(R.string.net_unavailable));
//                            return;
//                        }
