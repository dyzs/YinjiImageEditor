 ...
 */
public class CardTemplateAdapter_BAK extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    private Bitmap mBitmap;
    private ArrayList<CardTemplateInfo> mList;
    public CardTemplateAdapter_BAK(Context context, ArrayList<CardTemplateInfo> list) {
            ...
            templatesHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (position == mList.size()) {
                        ...
                        mOnItemClickListener.onItemClick(templatesHolder.itemView, position);
                    }
                }
            });
        }
